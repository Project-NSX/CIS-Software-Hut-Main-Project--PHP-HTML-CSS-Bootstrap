    ...
    while ($row = $supervisorApprovedresult->fetch_assoc()) {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4"><input type=submit name=approve value="<?php echo $lang['Approve'] ?>" class='btn btn-success' style='width:100%; margin-bottom:5px'></div>
                <div class="col-md-4"><input type=submit name=revise value="<?php echo $lang['Prompt User to Resubmit'] ?>" class='btn btn-warning' style='width:100%; margin-bottom:5px'></div>
                <div class="col-md-4"><input type=submit name=deny value="<?php echo $lang['Deny'] ?>" class='btn btn-danger' style='width:100%; margin-bottom:5px'></div>
            </div>
        </div>
