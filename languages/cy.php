<?php
	$lang = array(
		...
		"Start" => "Cychwyn",
		"End" => "Diwedd",
		"Date & Time of Initial Submission" => "Dyddiad y Cais",
		"Date & Time of Approval" => "Dyddiad Cymeradwyo'r Cais",
		...
		"Date & Time of Decision" => "Dyddiad y Penderfyniad",
		...
		"Visit End Date" => "Dyddiad Diwedd yr Ymweliad",
		"NOTICE" => "RHYBUDD",
		...
		"lang_en" => "English",
		"lang_cy" => "Cymraeg",
		"VA Login Page" => "Tudalen Mewngofnodi Ymwelwyr Academaidd",
		"reqInduction" => "<h2>Ymweliadau i Ddod</h2>",
		"H&S Induction" => "Anwythiad Iechyd a Diogelwch",
		"Cancel" => "Canslo",
		"Proceed" => "Ymlaen",
		"H&S Intro" => "Cyn eich ymweliad, mae'n rhaid i chi fod yn ymwybodol o bolisïau Iechyd a Diogelwch y Brifysgol. Mae modd i chi ddarllen y polisïau drwy'r ddolen isod. Ar ôl i chi ddarllen y polisïau, pwyswch y botwm 'ymlaen'.",
		"H&S Link" => "Cliciwch yma i ddarllen y polisïau.",
		...
		"VALogin1" => "Dylir ymwelwyr academaidd fewngofnodi drwy'r dudalen ",
		"VALogin2" => "yma.",
